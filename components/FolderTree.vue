...
<template>
  ...
  >
    <button
      ...
      @click="expand = true"
    >
      <Icon name="ph:folder-fill" class="shrink-0 w-6 h-6 text-yellow-400" />
    ...
    >
      <div class="w-full flex justify-between items-center">
        ...
        >
          <Icon name="ph-folder-open-fill" class="text-yellow-400 group-active:text-white" />
        ...
        <div class="shrink-0 pl-2 flex items-center gap-0.5">
          ...
          >
            <Icon name="ic:round-keyboard-arrow-left" class="w-3.5 h-3.5" />
          </button>
          <button
            v-show="showScrollBtn"
          ...
          >
            <Icon name="ic:round-keyboard-arrow-right" class="w-3.5 h-3.5" />
          </button>
          <button
            ...
            @click="expand = false"
          >
            <Icon name="ion:close" class="w-3.5 h-3.5" />
          </button>
        </div>
      </div>
      ...
      >
        <template v-for="(item, index) in currentTree">
          ...
          >
            <Icon name="ph:folder-fill" class="shrink-0 w-5 h-5 text-yellow-400 group-active:text-white" />
            <span class="text-sm break-all">
              {{ item.title }}
            </span>
          </button>
